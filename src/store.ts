...
interface SyllabusState {
  ...
  addTransitNotifications: (notifications: Omit<TransitNotification, 'id' | 'date' | 'isRead'>[]) => void;
  ...
  addHoraryEntry: (entry: Omit<HoraryHistoryEntry, 'id' | 'date'>) => void;
...
const INITIAL_QUOTES = [
  { id: '1', text: "The stars are not in the sky, they are in your soul.", author: "The Syllabus" },
  { id: '2', text: "Every question contains its own answer, if you look deep enough.", author: "The Syllabus" },
  { id: '3', text: "Time is not a line, but a circle of resonance.", author: "Chronicle" },
  { id: '4', text: "Your frequency determines your reality.", author: "Resonance" }
];
