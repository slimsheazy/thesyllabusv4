...
import { MapPin, Calendar, Clock, Sparkles, RefreshCw, Share2, Download, Loader2 } from 'lucide-react';
...
export const BirthChartTool: React.FC<BirthChartToolProps> = ({ onBack }) => {
  ...
  const [subject, setSubject] = useState({
    ...
    location: userLocation ? { ...userLocation } : null as any,
    isMe: true
  });
            ...
            <AnimatePresence>
              {analysis && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-6">
                    <h3 className="col-header border-b border-archive-line pb-2">Synthesis</h3>
