...
import { PenTool, Download, Trash2, Sparkles, RefreshCw, Share2, Loader2 } from 'lucide-react';
...
export const SigilMaker: React.FC<SigilMakerToolProps> = ({ onBack }) => {
  ...
  const generateSigil = async () => {
    ...
    try {
      ...
      setLoading(false);
      if (navigator.vibrate) navigator.vibrate([20, 40, 20, 40, 50]); // Forging haptic pattern
    }
  };
