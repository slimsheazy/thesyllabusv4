...
import { Calendar, Moon, Quote, Smile, Star, Search, Trash2, Clock, Eye, Download, X } from 'lucide-react';
...
export const MasterArchive: React.FC<MasterArchiveProps> = ({ onBack }) => {
  const { 
    dreams, quotes, moodLogs, horaryHistory,
    removeDream, removeQuote, removeMoodLog, removeHoraryEntry 
  } = useSyllabusStore();
