...
import { User, Calendar, Clock, MapPin, Check, ArrowRight, Loader2, Sparkles, UserCheck } from 'lucide-react';
import { useSyllabusStore, UserLocation } from '../store';
                      ...
                      <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        <div className="flex flex-col items-center gap-2">
                          <p className="text-[10px] italic opacity-60 text-center px-4">
                            {isEditingSigns ? "Adjust your signs as needed." : "Does this data accurately reflect your birth information?"}
                          </p>
                          <button 
