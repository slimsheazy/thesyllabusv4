...
import { Moon, Save, Trash2, RefreshCw, Search, Calendar, Filter, X, Sparkles, Loader2 } from 'lucide-react';
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <AnimatePresence>
              {interpretation && (
                ...
                >
                  <div className="absolute top-2 right-2 opacity-10"><Sparkles size={16} /></div>
